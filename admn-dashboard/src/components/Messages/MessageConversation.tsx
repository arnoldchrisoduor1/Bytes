...
const MessageConversation:React.FC<MessageConversationProps> = ({ name, message }) => {
  return (
    <div className="flex flex-row border border-slate-600 gap-3 items-center w-full mt-1 hover:translate-x-1 hover:cursor-pointer transition duration-300 ease-in-out">
